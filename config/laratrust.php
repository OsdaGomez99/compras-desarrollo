...
return [
    ...
    */
    'tables' => [
        ...
        'roles' => 'segurity.roles',

        'permissions' => 'segurity.permissions',

        /**
         * Will be used only if the teams functionality is enabled.
         */
        'teams' => 'segurity.teams',

        'role_user' => 'segurity.role_user',

        'permission_user' => 'segurity.permission_user',

        'permission_role' => 'segurity.permission_role',
    ],
